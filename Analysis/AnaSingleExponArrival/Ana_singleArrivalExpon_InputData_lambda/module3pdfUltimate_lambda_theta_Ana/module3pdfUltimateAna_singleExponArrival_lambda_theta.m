...
CCRplot = semilogx(Data_singleLambdaMTC_theta15(:,1) , CCRreductionSim(:,1),'rO' ...
              ,Data_singleLambdaMTC_theta30(:,1) , CCRreductionSim(:,2),'k*' ...
              ,Data_singleLambdaMTC_theta60(:,1) , CCRreductionSim(:,3),'bdiamond' ...
              ,lambda(:), CCRreductionAna(:,1),'r-' ...
              ,lambda(:),CCRreductionAna(:,2),'k-.' ...
              ,lambda(:),CCRreductionAna(:,3),'b--') ;  
