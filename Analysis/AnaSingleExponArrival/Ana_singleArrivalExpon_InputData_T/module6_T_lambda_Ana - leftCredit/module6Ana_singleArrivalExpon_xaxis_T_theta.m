...
subplot(2,2,3) ;
Erc=semilogx(Data_singleArrivalExpon_T_1lambda(:,1) , Data_singleArrivalExpon_T_1lambda(:,4),'rO' ...
        ,Data_singleArrivalExpon_T_5lambda(:,1) , Data_singleArrivalExpon_T_5lambda(:,4),'g*' ...
        ,Data_singleArrivalExpon_T_10lambda(:,1) , Data_singleArrivalExpon_T_10lambda(:,4),'bdiamond' ...
        ,T(1,:), ECruarray(1,:),'r-' ...
        ,T(1,:) , ECruarray(2,:),'g-' ...
        ,T(1,:) , ECruarray(3,:),'b-') ; 
xlabel(['T ( Unit: time unit )' ,sprintf('\n\n'), ...
